...
// LatoFont
#define COCOAPODS_POD_AVAILABLE_LatoFont
#define COCOAPODS_VERSION_MAJOR_LatoFont 1
#define COCOAPODS_VERSION_MINOR_LatoFont 0
#define COCOAPODS_VERSION_PATCH_LatoFont 0
