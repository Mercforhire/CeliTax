...
@interface LeftSideMenuView () <UITableViewDataSource, UITableViewDelegate> {
...
@implementation LeftSideMenuView
...
- (void)baseInit {
	...
	usernameLabel = [[UILabel alloc] initWithFrame:CGRectMake(profileImageView.frame.origin.x + profileImageView.frame.size.width + 10,
